...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Dog":
			resolverName, err := entityResolverNameForDog(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Dog": %w`, err)
			}
			switch resolverName {
			...
			case "findDogByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findDogByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindDogByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Dog": %w`, err)
				}
...
func entityResolverNameForDog(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findDogByID", nil
	}
	return "", fmt.Errorf("%w for Dog", ErrTypeNotFound)
}
