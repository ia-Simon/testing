...
export declare type QueryRouterEntitlementsArgs = {
    apiKey: Scalars['String'];
    ref: Scalars['String'];
...
export declare type RouterEntitlement = {
...
export declare type RouterEntitlementsResponse = FetchError | RouterEntitlementsResult | Unchanged;
export declare type RouterEntitlementsResult = {
